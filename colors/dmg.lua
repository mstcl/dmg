...
local highlight_groups = {
	...
	mkdCode = { bg = statusline_group.bg, fg = gray1 },
	...
	mkdURL = { fg = green1, style = "underline" },
	...
	["@markup.strikethrough"] = "markdownStrike",
	["@markup.link.url"] = "mkdURL",
	["@markup.link.label"] = { fg = blue1 },
	["@function.macro"] = "ErrorMsg",
	["@string.escape"] = "Character",
	["@string.regex"] = "SpecialChar",
	["@string.special.url"] = "mkdURL",
	["@operator"] = "Operator",
