...
local gray0 = { "#5a5958", 244, "gray" }
local gray1 = { "#4d4d4c", 237, "darkgrey" }
local gray2 = { "#343332", 235, "gray" }
local gray3 = { "#272626", 233, "gray" }
local gray4 = gray2
local gray5 = { "#7c7c77", 243, "gray" }
local gray6 = { "#91908F", 251, "gray" }
local gray7 = { "#B9B8B3", 15, "white" }
local gray8 = { "#D9D8D2", 15, "white" }
local gray9 = { "#EBEAE5", 15, "white" }
local white0 = { "#F0EFEB", 15, "white" }
local white1 = { "#f5f4f2", 15, "white" }
...
local highlight_groups = {
	...
	TelescopeSelection = {
		...
		light = { bg = gray9, fg = amoled },
		style = { "bold" },
	},
	TelescopeSelectionCaret = { dark = { bg = gray2, fg = gray7 }, light = { bg = gray9, fg = amoled } },
